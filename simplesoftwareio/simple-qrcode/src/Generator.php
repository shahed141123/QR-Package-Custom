...
use BaconQrCode\Renderer\Eye\LeftDiamondEye;
use BaconQrCode\Renderer\Eye\LeftleafEye;
use BaconQrCode\Renderer\Eye\ModuleEye;
use BaconQrCode\Renderer\Eye\RightDiamondEye;
use BaconQrCode\Renderer\Eye\RightleafEye;
...
class Generator
{
    ...
    {
        if (! in_array($style, ['square', 'circle', 'left-diamond', 'right-diamond', 'left-leaf', 'right-leaf'])) {
    ...
    public function getEye(): EyeInterface
    {
        ...
        if ($this->eyeStyle === 'left-diamond') {
            return LeftDiamondEye::instance();
        }
        if ($this->eyeStyle === 'right-diamond') {
            return RightDiamondEye::instance();
        }
        if ($this->eyeStyle === 'left-leaf') {
            return LeftleafEye::instance();
        }
        if ($this->eyeStyle === 'right-leaf') {
            return RightleafEye::instance();
        }
